  ...
  const slides: ISlide[] = [
    {
      ...
      text1:
        'Разработали сервис финансирования, который позволяет предпринимателям быстро получать займы от инвесторов напрямую, минуя сложный процесс сбора документов и оформления залогов',
    },
    {
    ...
    },
    {
      ...
      text1:
        'Разрабатывали инновационного бота, обладающего способностью анализировать содержание веб-сайтов и автоматически отбирать видеоматериалы из публичных источников, соответствующие тематике сайта.',
      text2:
    ...
    },
    {
      ...
      text1:
        'Рефакторинг раздела спецпроектов. Добавление в футер поста вывод постов соответствующей тематики с Infinite-scroll’ом. Авторизация с регистрацией и восстановлением пароля у проекта была вынесена в отдельный микросервис.',
      text2:
