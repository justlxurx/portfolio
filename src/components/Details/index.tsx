...
const Details = () => {
  ...
  const handleLeftButtonClick = () => {
    ...
    const scrollContainer = document.querySelector('.intensive_details__main__display');
    scrollContainer?.classList.remove('moveRight');
    scrollContainer?.classList.add('moveLeft');

    if (scrollContainer?.classList.contains('moveLeft')) {
      // Класс 'moveLeft' добавлен к элементу.
      console.log('Класс moveLeft добавлен');
    } else {
      // Класс 'moveLeft' не добавлен к элементу.
      console.log('Класс moveLeft не добавлен');
    }
  };
  ...
  const handleRightButtonClick = () => {
    ...
    const scrollContainer = document.querySelector('.intensive_details__main__display');
    scrollContainer?.classList.add('moveRight');
    scrollContainer?.classList.remove('moveLeft');
  ...
  useEffect(() => {
    const leftButton = document.querySelector('.button_to_left');
    const rightButton = document.querySelector('.button_to_right');
    ...
    <section className={styles.intensive_details}>
      <div className={styles.intensive_details__heading} >
        ...
        <div className={styles.buttons_for_scrolling}>
          <button className={styles.button_to_left} onClick={() => handleLeftButtonClick()}></button>
          <button className={styles.button_to_right} onClick={() => handleRightButtonClick()}></button>
        </div>
      </div>
