...
>>>>>>> bff2690bdff417b4002d9636a1e3cf9b9d85b776
const Career = () => {
  return(
    ...
    <div className={styles.in_it}>
      <div className={styles.first_row}>
           <div className={styles.first_row_first_column}>
              <div className={styles.first_row_first_column_1}>
                <div className={styles.borders} >
                  <Image src={quadratic} alt="quadratic" style={{alignSelf:"start"}}/>
                </div>
              ...
              <div className={styles.first_row_first_column_2}>
                <div className={styles.borders}>
                  <Image src={quadratic} alt="quadratic" style={{alignSelf:"center"}}/>
                  </div>
                <div className={styles.borders}></div>
                <div></div>
               </div>
              <div className={styles.first_row_first_column_3}>
                ...
                Мы не нанимаем сотрудников, <br /> мы расширяем команду</div>
              ...
              <FeedbackButton1 /></div>
              <div className={styles.quad2}>
                <Image src={quadratic} alt="quadratic" style={{alignSelf:"end"}}/>
                <Image src={quadratic} alt="quadratic" style={{alignSelf:"center"}}/>
                </div>
            </div>

              <div className={styles.first_row_first_column_4}>
                <div className={styles.borders} style={{display:"grid", gridTemplateRows:"1fr 1fr"}}>
                <Image src={quadratic} alt="quadratic" style={{alignSelf:"end"}}/>
                <Image src={quadratic} alt="quadratic" style={{alignSelf:"end"}}/>
                </div>
                <div className={styles.borders} style={{display:"grid", gridTemplateRows:"1fr 1fr"}}>
                <Image src={quadratic} alt="quadratic" style={{alignSelf:"end", justifySelf:"center"}}/>
                <Image src={quadratic} alt="quadratic" style={{alignSelf:"end", justifySelf:"center"}}/>
               </div>
                <div></div>
              </div>
           ...
           <div className={styles.first_row_second_column}>
              ...
              <Image src={quadratic} alt="quadratic" style={{justifySelf:"end"}} />
              <div></div>
                <Image src={quadratic} alt="quadratic" style={{justifySelf:"start"}} />
             </div>
              <div className={styles.first_row_second_column_2}>
              <Image src={quadratic} alt="quadratic" style={{justifySelf:"end", alignSelf:"center"}}  />
              <div></div>
                <Image src={quadratic} alt="quadratic" style={{justifySelf:"start", alignSelf:"center"}} />
               
              </div>
              <div className={styles.first_row_second_column_3}>
                <div className={styles.for_grid}>
              <Image src={quadratic} alt="quadratic" style={{justifySelf:"end", alignSelf:"end"}}  />
              <div></div>
                <Image src={quadratic} alt="quadratic" style={{justifySelf:"start", alignSelf:"end"}} />
             </div>
              </div>
              <div  className={styles.first_row_second_column_4} style={{borderBottom:"none"}}>
               
               <div style={{alignSelf:"end", display:"grid", gridTemplateColumns:"2fr 0.2fr 4.5fr"}}>
                <Image src={quadratic} alt="quadratic" style={{justifySelf:"end"}} />
                <div></div>
           ...
           <div className={styles.first_row_five_column} style={{display:"grid", gridTemplateRows:"2fr 1fr 1.8fr 0.7fr"}}>
           <Image src={quadratic} alt="quadratic"  />
           <Image src={quadratic} alt="quadratic"  />
           <Image src={quadratic} alt="quadratic"/>
           <Image src={quadratic} alt="quadratic" />
