...
export const DashboardShengen = () => {
  ...
  const { data: otherCountry, isLoading: countryLoading } =
    useGetShengenImagesQuery();
  ...
  const saveEdits = async () => {
    if (editableRow !== null) {
      try {
        ...
        dispatch(
          updateCountry({ index: editableRow, updatedData: editableData })
        );
      } catch (error) {
                ...
                >
                  ...
                  <td>
                    <input
                      type="text"
                      value={
                        editableRow === index ? editableData.name : data.name
                      }
                  ...
                  <td>
                    <input
                      type="text"
                      value={
                        editableRow === index ? editableData.image : data.image
                      }
                      onChange={(e) => handleInputChange(e, "image")}
                      disabled={editableRow !== index}
                      style={{
                        backgroundColor: `${
                          editableRow !== index ? "inherit" : "white"
                        }`,
                      }}
                    />
                  </td>
                  <td>
                    <input
                      type="text"
                      value={
                        editableRow === index ? editableData.price : data.price
                      }
                  ...
                  <td>
                    <textarea
                      value={
                        editableRow === index ? editableData.title : data.title
                      }
                  ...
                  <td>
                    <textarea
                      value={
                        editableRow === index ? editableData.text : data.text
                      }
