...
const Modules = (module) => {
  return (
    <div class="program-item-3__content-wrapper">
      <div class="program-item-3__content-collapse">
        <p class="program-item-3__content-collapse-p">{module.title}</p>
        <button
          // onclick="hide('${module.id2}'); plusOrMinus('${module.id1}')"
          onClick={() => {
            hide(module.id2);
            plusOrMinus(module.id1);
          }}
          class="plus"
          id={module.id1}
        ></button>
      </div>
      <div class="program-item-3__content-wrapper-main hide" id={module.id2}>
        <div class="program-item-3__content-wrapper-para">
          <p>{module.topics}</p>
        </div>
...
const sec = document.querySelector(".program-item-3__content");
programsArray.forEach((programs) => {
  const moduleSection = Modules(programs);
